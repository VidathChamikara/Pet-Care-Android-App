...
public class shop_show_orders extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_shop_show_orders);

        logo = findViewById(R.id.app_logo_top);
        logo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(shop_show_orders.this, Home.class);
            ...
            protected void onBindViewHolder(@NonNull OrdersViewHolder adminViewHolder, final int i, @NonNull final Order order) {
                ...
                if(status.equals("Pending")) {
                    adminViewHolder.viewAllBtn.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View view) {
                            Intent intent = new Intent(shop_show_orders.this, shop_viewOrderitems.class);
